...
<div class="h-50 center-me text-center">
    <div class="my-auto upload-container">
        <form action ="includes/gallery-helper.php" method ="POST"enctype="multipart/form-data">
            ...
            <img src="images/login.jpg" onclick="triggered();" id="gallery-display">
            ...
            <div class="form-group">
                <button type = "submit" name="gallery-submit" class="btn btn-outline-sucess btn-lg btn-block">upload</button>
            </div>
       </form> 
    </div>
</div>
